...
I am an associate professor of the Graduate School of Information Science and Electrical Engineering (ISEE) in Kyushu University, Japan. I am also an affiliate faculty member of School of Engineering, School of Science, and Joint Graduate School of Mathematics for Innovation in Kyushu University. In ISEE, I am belonging to [the multi-agent laboratory](https://agent.inf.kyushu-u.ac.jp). My major research field is multi-agent systems, a subfield of artificial intelligence. More specifically, my research focuses on algorithmic aspects of mechanism design, including resource allocations and social choice. Further information on my research is found at 
...
- **Analyzing Incentives and Fairness in Ordered Weighted Average for Facility Location Games**. ECAI-24. (with Kento Yoshida, Kei Kimura, and Makoto Yokoo) [PDF](OWA_for_Facility_Location.pdf)
